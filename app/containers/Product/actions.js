...
// ==========================================
export const fetchMemorialProducts = (obituaryId = null, type = null) => {
  return async (dispatch, getState) => {
    try {
      dispatch(setProductLoading(true));
...
// ==========================================
// Fetch Store Product (Supports both slug and ID)
// ==========================================
export const fetchStoreProduct = (identifier, useId = false) => {
  return async (dispatch, getState) => {
    dispatch(setProductLoading(true));
...
// ==========================================
// Fetch Store Product By Slug (convenience method)
// ==========================================
export const fetchStoreProductBySlug = slug => {
  return fetchStoreProduct(slug, false);
};

// ==========================================
// Fetch Store Product By ID (convenience method)
// ==========================================
export const fetchStoreProductById = id => {
  return fetchStoreProduct(id, true);
};
...
// fetch products api (admin/merchant)
...
// fetch product api (admin/merchant)
  ...
  return async (dispatch, getState) => {
    try {
      ...
      const newProduct = {
        ...
        type: product.type || null, // Support product type (tree, flower, gift)
        brand:
  ...
  return async (dispatch, getState) => {
    try {
      ...
      const newProduct = {
        ...
        type: product.type || null, // Support product type
